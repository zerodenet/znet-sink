<script lang="ts">
  import PluginsSettingsPanel from '$lib/components/settings/PluginsSettingsPanel.svelte';
  ...
  import DiagnosticsPanel from '$lib/components/tabs/DiagnosticsPanel.svelte';
  import ModuleDiagnosticsFixture from './ModuleDiagnosticsFixture.svelte';
  ...
  import ProfilesTab from '$lib/components/tabs/ProfilesTab.svelte';
